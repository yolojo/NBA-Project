...
```{r}
nbatable <- read.csv(file = "~/Desktop/PSU Grad School/STAT 564/NBA Project/NEW NBA.csv", header = TRUE)
nbatable
```
...
From the Normality Probability plot, we can assume the residuals are normaly distributed.
